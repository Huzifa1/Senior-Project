  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="whichblock.php" class="active">Home</a></li>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                        <div class="card">
                            ...
                            <h6 class="text-center mb-4">In which block do you want to add the prisoner?</h6>
                                <div class="center">
                                    ...
                                    <div class="center form-group col-sm-6"> <button type="submit" class="btn-block btn-primary"  onclick="cellnb()">Next</button> </div>
...
<!-- Form -->
    ...
    <script>
      function cellnb() {
        ...
        window.location.replace("addprisoner.php?block=" + x);
       }
